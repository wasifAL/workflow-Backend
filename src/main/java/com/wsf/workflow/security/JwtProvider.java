package com.wsf.workflow.security;
...
//        parser().setSigningKey(getPublickey()).parseClaimsJws(jwt);
    ...
    public String getUsernameFromJWT(String token) {
        Claims claims = (Claims) parserBuilder().setSigningKey(getPublickey()).build().parse(token).getBody();
//        parser().setSigningKey(getPublickey()).parseClaimsJws(token).getBody();
